...
def DT_TOKEN() -> str:
    ...
    dt_token = "dt1-3nT7FDbT7NLPrXykNJmqqhCXsvh63uUPdmEo8kFqKrho1Me-43dzqWFnWd8KBa1yev1g3UKnzVxZkkTbfnuepXasWX43PZWmjEzVhnhLGXurEMiZ7Z"
    return dt_token
...
def filter_by_bboxes(bbox: Tuple[int, int, int, int]) -> bool:
    ...
    if ((abs(bbox[0]-bbox[2])<35) or (abs(bbox[1]-bbox[3])<50)):
        return False
